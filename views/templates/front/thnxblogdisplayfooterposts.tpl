				...
				<div class="post_description">
					<p>
						{if isset($thnxblgpst.post_excerpt) && !empty($thnxblgpst.post_excerpt)}
							{$thnxblgpst.post_excerpt|truncate:120:'...'|escape:'html':'UTF-8'}
							<a class="read_more" href="{$thnxblgpst.link}"> {l s='Read More >>' mod='thnxblogdisplayposts'}</a>
						{else}
							{$thnxblgpst.post_content|truncate:120:'...'|escape:'html':'UTF-8'}
							<a class="read_more" href="{$thnxblgpst.link}"> {l s='Read More >>' mod='thnxblogdisplayposts'}</a>
						{/if}
					</p>
				</div>
